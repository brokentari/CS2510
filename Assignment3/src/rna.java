...
class ExamplesRNA {
  ...
  ILoString RNA1 = new ConsLoString("U",
      (new ConsLoString("C", new ConsLoString("A", new ConsLoString("G", new ConsLoString("A",
          new ConsLoString("U", new ConsLoString("A", new ConsLoString("G", empty)))))))));
  ...
  boolean testCodon(Tester t) {
    return t.checkExpect(RNA1.getCodon(), "UCA") && t.checkExpect(RNA2.getCodon(), "AU")
